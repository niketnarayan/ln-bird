...
>
<i className="fa-solid fa-cart-shopping"></i> Cart <span style={{color:"green"}}>{cartlength}</span>
</Button>
...
Save Changes
    ...
    {/* slider merge end---------------------------------------------------------------------------- */}
      ...
      <div className='row'>
        <div className='col'>
           <img src='https://tbn-prod-assets.s3.ap-south-1.amazonaws.com/cms_1732011062871.jpeg' alt='...' className='img-fluid'></img>
        </div>
        </div> 
        </div>

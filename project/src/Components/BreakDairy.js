            ...
            <div className="row">
              ...
              >
                <div className="product-card position-relative p-2">
                  ...
                  <img
                    src="https://klbtheme.com/bacola/wp-content/uploads/2021/04/product-image-58-600x540.jpg"
                    className="img-fluid mb-3"
                    alt="Product Image"
                  />
                  <h5 className="mb-2">Fresh Organic Blueberries</h5>
                  <p>1 kg | In Stock</p>
                  {/* Adjusted the layout */}
              ...
              >
                <div className="product-card position-relative p-2">
                  ...
                  <img
                    ...
                    alt="Product Image"
                  />
                  <h5 className="mb-2">Chobani Vanilla Greek Yogurt
                  </h5>
                  <p>1 kg | In Stock</p>
                  {/* Adjusted the layout */}
                  <div className="d-flex justify-content-between align-items-center mt-2">
              ...
              >
                <div className="product-card position-relative p-2">
                  ...
                  <img
                    src="https://klbtheme.com/bacola/wp-content/uploads/2021/04/product-image-61-600x540.jpg"
                    className="img-fluid mb-3"
                    alt="Product Image"
                  />
                  <h5 className="mb-2">American Cheese Singles</h5>
                  <p>1 kg | In Stock</p>
                  {/* Adjusted the layout */}
                  <div className="d-flex justify-content-between align-items-center mt-2">
                    <span>
              ...
              >
                <div className="product-card position-relative p-2">
                  ...
                  <img
                    src="https://klbtheme.com/bacola/wp-content/uploads/2021/04/product-image-47-600x540.jpg"
                    className="img-fluid mb-3"
                    alt="Product Image"
                  />
                  <h5 className="mb-2">Fairlife Lactose-Free 2% Milk</h5>
                  <p>1 kg | In Stock</p>
                  {/* Adjusted the layout */}
                  <div className="d-flex justify-content-between align-items-center mt-2">
                    <span>

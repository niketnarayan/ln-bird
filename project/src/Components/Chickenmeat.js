            ...
            <div className="row">
              ...
              >
                <div className="product-card position-relative p-2">
                  ...
                  <img
                    src="https://klbtheme.com/bacola/wp-content/uploads/2021/04/product-image-7-600x540.jpg"
                    className="img-fluid mb-3"
                    alt="Product Image"
                  />
                  <h5 className="mb-2">Fresh Meat</h5>
                  <p>1 kg | In Stock</p>
                  {/* Adjusted the layout */}
              ...
              >
                <div className="product-card position-relative p-2">
                  ...
                  <img
                    src="https://klbtheme.com/bacola/wp-content/uploads/2021/04/product-image-31-600x540.jpg"
                    className="img-fluid mb-3"
                    alt="Product Image"
                  />
                  <h5 className="mb-2">Fresh Meat</h5>
              ...
              >
                <div className="product-card position-relative p-2">
                  ...
                  <img
                    src="https://klbtheme.com/bacola/wp-content/uploads/2021/04/product-image-48-600x540.jpg"
                    className="img-fluid mb-3"
                    alt="Product Image"
                  />
                  <h5 className="mb-2">Eggs</h5>
                  <p>1 kg | In Stock</p>
                  {/* Adjusted the layout */}
                  <div className="d-flex justify-content-between align-items-center mt-2">
                    <span>
              ...
              >
                <div className="product-card position-relative p-2">
                  ...
                  <img
                    src="https://klbtheme.com/bacola/wp-content/uploads/2021/04/product-image-62-600x540.jpg"
                    className="img-fluid mb-3"
                    alt="Product Image"
                  />
                  <h5 className="mb-2">Fresh Organic Chicken</h5>
                  <p>1 kg | In Stock</p>
                  {/* Adjusted the layout */}
                  <div className="d-flex justify-content-between align-items-center mt-2">
                    <span>

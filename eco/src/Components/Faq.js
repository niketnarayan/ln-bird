...
function Faq() {
 ...
 <div style={{ padding: "40px", backgroundColor: "#f9f9f9",marginTop:"9rem" }}>
      ...
      <section>
        <h4 style={{ color: "#333" }}>1. What ingredients are used in Kiona products?</h4>
      ...
      <section>
        <h4 style={{ color: "#333" }}>2. Are Kiona products suitable for all skin types?</h4>
        <p style={{ fontSize: "18px", color: "#555", lineHeight: "1.6" }}>
      ...
      <section>
        <h4 style={{ color: "#333" }}>3. Are Kiona products tested on animals?</h4>
        <p style={{ fontSize: "18px", color: "#555", lineHeight: "1.6" }}>
      ...
      <section>
        <h4 style={{ color: "#333" }}>4. How do I use Kiona skincare products?</h4>
        <p style={{ fontSize: "18px", color: "#555", lineHeight: "1.6" }}>
      ...
      <section>
        <h4 style={{ color: "#333" }}>5. Are your products safe for sensitive skin?</h4>
        <p style={{ fontSize: "18px", color: "#555", lineHeight: "1.6" }}>
      ...
      <section>
        <h4 style={{ color: "#333" }}>6. Do you offer international shipping?</h4>
        <p style={{ fontSize: "18px", color: "#555", lineHeight: "1.6" }}>
      ...
      <section>
        <h4 style={{ color: "#333" }}>7. How can I contact Kiona customer support?</h4>
        <p style={{ fontSize: "18px", color: "#555", lineHeight: "1.6" }}>
      ...
      <section>
        <h4 style={{ color: "#333" }}>8. What is your return policy?</h4>
        <p style={{ fontSize: "18px", color: "#555", lineHeight: "1.6" }}>
      ...
      <section>
        <h4 style={{ color: "#333" }}>9. How do I track my order?</h4>
        <p style={{ fontSize: "18px", color: "#555", lineHeight: "1.6" }}>
      ...
      <section>
        <h4 style={{ color: "#333" }}>10. Are your products environmentally friendly?</h4>
        <p style={{ fontSize: "18px", color: "#555", lineHeight: "1.6" }}>
